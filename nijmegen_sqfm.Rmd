...
![Generations of Programming languages](./images/languages.png){height=75%}
...
A plug-in-based open-source cross-platform framework for ANSI-`C` source-code analysis:
...
Now we can identify the actual bugs:
