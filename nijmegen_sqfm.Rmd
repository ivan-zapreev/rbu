...
## Software Verification: In formal
...
Consider the problem of multiplying all array elements by `2`:
...
Hoare/Dijkstra approach for proving correctness of *imperative programs*.
...
We need to make our specification **complete**:
...
The verification is $\color{blue}{\bf{OK}}$, but the spec is lame:
